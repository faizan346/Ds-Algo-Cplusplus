...
class LinkedList {
    ...
    //dont do this like this making complex is not good..
    // Node* intersectionTwoListHelper(LinkedList l1, Node* i, int n, LinkedList l2, Node* j, int m) {
    //     if(i == NULL || j == NULL) {
    //         return NULL;
    //     }
    //     if(n > m) {
    //         return intersectionTwoListHelper(l1, i->next, n-1, l2, j, m);
    //     } else if(n < m) {
    //         return intersectionTwoListHelper(l1, i, n, l2, j->next, m-1);
    //     } else {
    //         Node* res = intersectionTwoListHelper(l1, i->next, n-1, l2, j->next, m-1);
    //         if(res == NULL && i != j) {
    //             return i->next;
    //         }
    //         return res;
    ...
    //     return intersectionTwoListHelper(l1, l1.head, l1.size, l2, l2.head, l2.size);
    // }
    Node* intersectionTwoList(LinkedList l1, LinkedList l2) {
        Node* t1 = l1.head;
        Node* t2 = l2.head;
